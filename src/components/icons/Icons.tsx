...
export const SearchIcon = ({ size, height, width, ...props }: { 
  size?: number;
  height?: number;
  width?: number;
  [key: string]: any;
...
export const UserIcon = ({ size, height, width, ...props }: { 
  size?: number;
  height?: number;
  width?: number;
  [key: string]: any;
...
export const HeartIcon = ({ size, height, width, filled = false, ...props }: { 
  size?: number;
  height?: number;
  width?: number;
  filled?: boolean;
...
export const ArrowRightIcon = ({ size, height, width, ...props }: { 
  size?: number;
  height?: number;
  width?: number;
  [key: string]: any;
...
export const Logo = ({ className = "", ...props }: { className?: string, [key: string]: any }) => {
  return (
    <div className={`font-bold text-xl tracking-wider ${className}`} {...props}>
      PRIMESHOP
    </div>
  );
};

export const StarIcon = ({ size, height, width, filled = true, ...props }: { 
  size?: number;
  height?: number;
  width?: number;
  filled?: boolean;
